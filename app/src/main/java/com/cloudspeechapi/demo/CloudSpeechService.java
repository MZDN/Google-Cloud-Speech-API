...
public class CloudSpeechService extends Service {
    ...
    private static final String TAG = "CloudSpeechService";

    private static final String PREFS = "CloudSpeechService";
    ...
    public static CloudSpeechService from(IBinder binder) {
    ...
    private class SpeechBinder extends Binder {
        ...
        CloudSpeechService getService() {
            return CloudSpeechService.this;
        }
